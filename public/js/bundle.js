...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2piMTYiLCJhIjoiY2s5eDM3aW85MGczOTNsbWtwMTNuNWo0byJ9.arYbDgkeAl8jVdhLNt_ibQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kjb16/ck2nhtyj51cl11cov9b9ke4zj',
    scrollZoom: false // center: [-79.393321, 43.647961],
    // zoom: 13,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extends map bound to include current location
...
var stripe = Stripe('pk_test_KdsL4PT69om6kVNjQlOXerMY00CY0O5AQ9');
...
},{"./mapbox":"mapbox.js","./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./signup":"signup.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
