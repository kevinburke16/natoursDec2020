      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: '127.0.0.1:3000/api/v1/users/logout'
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              location.assign('/me'), (0, _alerts.showAlert)("Data updated successfully!");
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("127.0.0.1:3000/v1/bookings/checkout-session/".concat(tourId));
